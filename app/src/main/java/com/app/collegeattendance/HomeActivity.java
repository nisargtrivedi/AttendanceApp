...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvName.setText(appPreferences.getString("name"));
        textView.setText(appPreferences.getString("code"));
        Picasso.with(this).load(appPreferences.getString("photo")).into(imageView);
    }
